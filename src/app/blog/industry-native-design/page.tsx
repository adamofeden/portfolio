...
export default function Page() {
  const structuredData = {
    ...
    "@type": "BlogPosting",
    headline: "Designing Software That Feels Native: Why Your App Should Speak the Language of Its Industry",
    description: "Most software feels like a tech product dropped into an industry. Here's why studying industry tools, their patterns, workflows, and design language,creates software users understand immediately, based on building products for insurance, law, finance, and education.",
    author: {
      "@type": "Person",
      name: "Adam Dugan",
      url: "https://adamdugan.com",
      jobTitle: "Software Engineer",
      knowsAbout: ["Journalism", "Engineering", "Product", "UX", "Travel"]
    },
    publisher: {
      "@type": "Person",
      name: "Adam Dugan",
    ...
    url: "https://adamdugan.com/blog/industry-native-design",
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": "https://adamdugan.com/blog/industry-native-design"
    }
  };
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Designing Software That Feels Native: Why Your App Should Speak the Language of Its Industry",
        item: "https://adamdugan.com/blog/industry-native-design"
      }
    ]
  };
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-3xl px-6 sm:px-8 py-16">
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          ...
          admin dashboards, CRM-style forms, SaaS navigation. These patterns work, but that doesn&apos;t mean the user will understand them. 
          When an insurance agent opens your app, they shouldn&apos;t 
          think &quot;this is software.&quot; They should think &quot;this is an insurance tool.&quot;
        </p>
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          ...
          Sheet&quot;</strong>, <strong>&quot;Trailing Twelve Months&quot;</strong>. Users shouldn&apos;t 
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          Before writing code, spend time with dominant tools: QuickBooks and Xero for finance, EZLynx 
          and AngencyBloc for health insurance. Look for vocabulary, information hierarchy, 
          input patterns, output formats, and error handling approaches. This gives you a grounded understanding
          of the industry, what exists and what&apos;s missing.
        </p>
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          ...
          switch between tools, manual verification steps, and workarounds. When building SOA Assist Pro, 
          watching agents constantly switch between CRMs, Excel, and paper templates told 
          me the software needed to feel like both a bookkeeping tool <em>and</em> a spreadsheet.
        </p>

        <h2 className="mt-10 text-2xl font-semibold">Real Example</h2>

        <h3 className="mt-8 text-xl font-semibold">BalancingIQ: Financial Automation</h3>

        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          I used exact GAAP (Generally Accepted Accounting Principles) financial statement layouts, accounting number conventions (negatives in 
        ...
        {<p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          ...
          design language users already speak</strong>. Like modern architecture, distinctly 
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          In BalancingIQ, I kept financial layouts traditional but added LLM-driven insights and natural 
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          ...
          finance patterns, that&apos;s industry-native design. When health insurance agents see audit 
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          ...
          proving you understand the industry deeply enough to speak its language and add new value.
        </p>
        ...
        <p className="mt-4 text-black/70 dark:text-white/70 leading-relaxed">
          I&apos;ve built software for insurance, finance, education, and law. 
