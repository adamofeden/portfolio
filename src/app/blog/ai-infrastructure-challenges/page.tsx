...
export default function Page() {
  const structuredData = {
    ...
    "@type": "BlogPosting",
    headline: "The Hard Part Isn't the Model: Real Challenges in Production AI Systems",
    description: "After building multiple AI-powered products, I've learned the hard way: the model is the easy part. The real challenges are multi-tenant isolation, cost control, explainability, and guardrails. Here's what actually matters in production.",
    author: {
      "@type": "Person",
      name: "Adam Dugan",
